...
public class JedisUtils {
    private static final JedisUtils redis = new JedisUtils();
    ...
    public static void init() {
        ...
        if (jedisPool == null) {
           ...
           // jedisPool = new JedisPool(config,bundle.getString("ip"), bundle.getString("port"),10000,JRedisPoolConfig.REDIS_PASSWORD);
